...
static const float default_part_load_ignitions[TABLE_FILLING_MAX][TABLE_ROTATES_MAX] = {
    { 18.9f, 20.6f, 22.5f, 24.9f, 28.1f, 32.3f, 38.8f, 41.5f, 43.1f, 44.0f, 44.5f, 45.0f, 44.9f, 44.9f, 45.6f, 45.1f },
    { 18.8f, 20.5f, 22.2f, 24.6f, 27.7f, 31.8f, 38.2f, 40.9f, 42.4f, 43.2f, 43.7f, 44.1f, 44.0f, 44.1f, 44.7f, 44.9f },
    ...
    { 6.0f, 6.0f, 6.1f, 6.7f, 7.8f, 8.5f, 10.0f, 12.0f, 15.5f, 18.4f, 20.2f, 20.1f, 18.8f, 18.9f, 19.3f, 19.6f },

};

static const float default_part_load_fuel_mixtures[TABLE_FILLING_MAX][TABLE_ROTATES_MAX] = {
    { 14.0f, 14.0f, 14.0f, 14.0f, 14.0f, 14.0f, 14.1f, 14.2f, 14.3f, 14.4f, 14.5f, 14.6f, 14.6f, 14.7f, 14.7f, 14.7f },
    { 14.0f, 14.0f, 14.0f, 14.0f, 14.0f, 14.0f, 14.1f, 14.2f, 14.3f, 14.4f, 14.5f, 14.6f, 14.6f, 14.7f, 14.7f, 14.7f },
    { 14.0f, 14.0f, 14.0f, 14.0f, 14.0f, 14.0f, 14.1f, 14.2f, 14.3f, 14.4f, 14.5f, 14.6f, 14.7f, 14.7f, 14.7f, 14.7f },
    { 14.0f, 14.0f, 14.0f, 14.0f, 14.0f, 14.0f, 14.1f, 14.2f, 14.3f, 14.4f, 14.6f, 14.7f, 14.7f, 14.7f, 14.7f, 14.7f },
    { 14.0f, 14.0f, 14.0f, 14.0f, 14.0f, 14.0f, 14.1f, 14.2f, 14.3f, 14.4f, 14.7f, 14.7f, 14.7f, 14.7f, 14.7f, 14.7f },
    { 14.0f, 14.0f, 14.0f, 14.0f, 14.0f, 14.1f, 14.2f, 14.3f, 14.4f, 14.5f, 14.7f, 14.7f, 14.7f, 14.7f, 14.7f, 14.7f },
    { 14.0f, 14.0f, 14.0f, 14.0f, 14.1f, 14.2f, 14.3f, 14.4f, 14.5f, 14.6f, 14.7f, 14.7f, 14.7f, 14.7f, 14.7f, 14.7f },
    { 14.0f, 14.0f, 14.0f, 14.1f, 14.2f, 14.3f, 14.4f, 14.5f, 14.6f, 14.7f, 14.7f, 14.7f, 14.7f, 14.7f, 14.7f, 14.7f },
    { 14.0f, 14.0f, 14.0f, 14.1f, 14.2f, 14.3f, 14.4f, 14.5f, 14.6f, 14.7f, 14.7f, 14.7f, 14.7f, 14.7f, 14.7f, 14.7f },
    { 14.0f, 14.0f, 14.4f, 14.3f, 14.4f, 14.5f, 14.6f, 14.6f, 14.6f, 14.6f, 14.6f, 14.6f, 14.6f, 14.6f, 14.6f, 14.6f },
    { 14.0f, 14.0f, 14.3f, 14.3f, 14.4f, 14.4f, 14.5f, 14.5f, 14.5f, 14.5f, 14.5f, 14.5f, 14.5f, 14.5f, 14.5f, 14.5f },
...
static const float default_part_load_injection_phase[TABLE_FILLING_MAX][TABLE_ROTATES_MAX] = {
    ...
    { 60, 80, 100, 100, 110, 110, 140, 170, 190, 190, 200, 200, 180, 140, 50, 10 },
    { 60, 80, 100, 100, 110, 120, 160, 190, 200, 210, 230, 220, 190, 150, 60, 20 },
    { 60, 80, 100, 100, 110, 130, 170, 190, 210, 230, 260, 240, 200, 160, 70, 30 },
...
static const float default_full_throttle_ignitions[TABLE_FILLING_MAX][TABLE_ROTATES_MAX] = {
    { 15.5f, 17.5f, 19.5f, 22.8f, 26.1f, 31.6f, 38.4f, 41.1f, 42.6f, 43.4f, 44.0f, 44.4f, 44.3f, 44.3f, 44.8f, 45.0f },
    { 16.1f, 18.0f, 20.1f, 23.1f, 26.6f, 31.9f, 38.5f, 41.2f, 42.6f, 43.4f, 44.0f, 44.4f, 44.3f, 44.3f, 44.8f, 45.0f },
...
static const float default_full_throttle_fuel_mixtures[TABLE_FILLING_MAX][TABLE_ROTATES_MAX] = {
    { 13.0f, 13.0f, 13.1f, 13.1f, 13.2f, 13.2f, 13.3f, 13.3f, 13.3f, 13.3f, 13.3f, 13.3f, 13.3f, 13.3f, 13.3f, 13.3f },
    { 13.0f, 13.0f, 13.1f, 13.1f, 13.2f, 13.2f, 13.3f, 13.3f, 13.3f, 13.3f, 13.3f, 13.3f, 13.3f, 13.3f, 13.3f, 13.3f },
    { 13.0f, 13.0f, 13.1f, 13.1f, 13.2f, 13.2f, 13.3f, 13.3f, 13.3f, 13.3f, 13.3f, 13.3f, 13.3f, 13.3f, 13.3f, 13.3f },
    { 13.0f, 13.0f, 13.1f, 13.1f, 13.2f, 13.2f, 13.3f, 13.3f, 13.3f, 13.3f, 13.3f, 13.3f, 13.3f, 13.3f, 13.3f, 13.3f },
    { 13.0f, 13.0f, 13.1f, 13.1f, 13.2f, 13.2f, 13.3f, 13.3f, 13.3f, 13.3f, 13.3f, 13.3f, 13.3f, 13.3f, 13.3f, 13.3f },
...
static const float default_injector_lag[TABLE_VOLTAGES_MAX] = {
    3.00f, 2.56f, 1.92f, 1.48f, 1.04f, 0.72f, 0.50f, 0.10f
};
...
static const float default_idle_wish_ignition_static[TABLE_ROTATES_MAX] = {
    ...
    22.0f, 14.0f, 11.0f, 10.0f, 12.0f, 16.0f, 21.0f, 25.0f
};
