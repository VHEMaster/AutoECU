    { 0.462f, 0.684f, 0.576f, 0.879f, 0.850f, 0.774f, 0.678f, 0.742f, 0.888f, 0.819f, 0.901f, 1.091f, 0.933f, 0.777f, 0.782f, 0.750f, },
    { 0.500f, 0.781f, 0.847f, 0.744f, 0.765f, 0.727f, 0.692f, 0.822f, 0.920f, 0.829f, 0.889f, 0.968f, 1.018f, 0.937f, 0.849f, 0.790f, },
    { 0.700f, 0.887f, 0.771f, 0.806f, 0.797f, 0.815f, 0.791f, 0.757f, 0.927f, 0.853f, 0.961f, 0.998f, 1.011f, 0.927f, 0.875f, 0.810f, },
    { 0.800f, 0.902f, 0.800f, 0.825f, 0.810f, 0.822f, 0.842f, 0.882f, 0.894f, 0.872f, 1.049f, 1.095f, 0.996f, 0.919f, 0.900f, 0.830f, },
};
...
static const float default_idle_wish_rotates[TABLE_TEMPERATURES_MAX] = {
    1700, 1700, 1700, 1700, 1650, 1600, 1500, 1400,
    1200, 1150, 1100, 1100, 1100, 1150, 1200, 1250,
};
...
static const float default_idle_wish_massair[TABLE_TEMPERATURES_MAX] = {
    35.0f, 35.0f, 35.0f, 35.0f, 33.0f, 31.0f, 24.0f, 22.0f,
    20.0f, 19.5f, 17.5f, 17.2f, 17.2f, 18.0f, 18.4f, 18.6f,
};
...
static const float default_idle_wish_ignition[TABLE_TEMPERATURES_MAX] = {
    35.0f, 35.0f, 35.0f, 35.0f, 34.0f, 32.0f, 30.0f, 28.0f,
    24.0f, 18.0f, 16.0f, 16.0f, 16.0f, 18.0f, 19.0f, 20.0f,
};
...
static const float default_idle_valve_to_massair_pid_d[TABLE_ROTATES_MAX] = {
    0.025f, 0.019f, 0.014f, 0.010f, 0.007f, 0.005f, 0.004f, 0.003f,
    0.002f, 0.002f, 0.001f, 0.001f, 0.001f, 0.001f, 0.001f, 0.001f
};
...
static const float default_idle_rpm_pid_act_1[TABLE_TEMPERATURES_MAX] = {
    0.400f, 0.400f, 0.400f, 0.400f, 0.400f, 0.400f, 0.400f, 0.400f,
    0.380f, 0.300f, 0.250f, 0.250f, 0.250f, 0.250f, 0.250f, 0.250f,
};
...
static const float default_idle_rpm_pid_act_2[TABLE_TEMPERATURES_MAX] = {
    ...
    0.470f, 0.370f, 0.320f, 0.320f, 0.320f, 0.320f, 0.320f, 0.320f,
};
